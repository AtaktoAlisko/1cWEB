...
const SlidebarMenuBar: React.FC = () => {
  ...
  const menuItems = [
    { title: "1С:ERP Управление предприятием", link: "/Enterprise/ERP" },
    { title: "1С:Управление холдингом 8", link: "/Enterprise/holding" },
    { title: "1С:Бухгалтерия 8", link: "/Enterprise/accounting" },
    {
      title: "1С:Зарплата и управление персоналом 8",
      link: "/Enterprise/salary",
    },
    { title: "1С:Управление торговлей 8", link: "/Enterprise/trade" },
  ];
...
export default SlidebarMenuBar;

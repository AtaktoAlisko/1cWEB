...
const ContactUs = () => {
  return (
    <div className=" min-h-screen flex items-center justify-center py-16 px-6 sm:px-10 lg:px-20 mt-14">
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Left Side */}
        <div className="bg-white dark:bg-gray-800 p-10 border-2 border-[#A22823] rounded-xl shadow-xl">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-blue-600 dark:text-blue-400 text-lg md:text-xl font-bold">
                Телефон: +7 (771) 200-56-26
              </p>
              <p className="text-blue-600 dark:text-blue-400 text-lg md:text-xl font-bold flex items-center">

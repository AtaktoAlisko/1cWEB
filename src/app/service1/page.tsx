        ...
        <div className="lg:flex lg:gap-8">
          ...
          <main className="lg:w-3/4">
            ...
            <section className="mb-12 bg-gray-50 rounded-lg p-8 shadow-sm">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Преимущества</h2>
              <div className="h-1 w-20 bg-red-600 mb-8"></div>
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={index} className="bg-white rounded-lg p-6 shadow-md transition duration-300 ease-in-out hover:shadow-lg">

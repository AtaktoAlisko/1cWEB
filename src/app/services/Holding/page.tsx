        ...
        <div className="lg:flex lg:gap-8">
          ...
          <main className="lg:w-3/4 order-1 lg:order-2">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Управление холдингом – комплексное решение класса CPM (Corporate
              Performance Management – управление эффективностью холдинга),
              предназначенное для автоматизации широкого спектра задач,
              связанных с учетом, планированием и контролем эффективности
              холдингов различного масштаба.
            </p>

            <p className="text-lg text-gray-700 dark:text-gray-300 mb-12">
              Программный продукт предназначен для комплексной автоматизации
              управляющих компаний холдингов
            </p>

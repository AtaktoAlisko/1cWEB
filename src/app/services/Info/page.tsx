        ...
        <div className="lg:flex lg:gap-8">
          ...
          <main className="lg:w-3/4 order-1 lg:order-2">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Стабильная работа информационных систем, в том числе
              «1С:Предприятие», является залогом эффективной деятельности Вашей
              организации.
            </p>

            <p className="text-lg text-gray-700 dark:text-gray-300 mb-12">
              Наша компания оказывает следующие услуги по технической поддержке
              информационных систем «1С:Предприятие»:
            </p>

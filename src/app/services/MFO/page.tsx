        ...
        <div className="lg:flex lg:gap-8">
          <main className="lg:w-3/4 order-1 lg:order-2">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              Данное комплексное решение на базе системы 1С:Предприятие8
              предназначено для банков и компаний, специализирующихся на
              предоставлении услуг в области кредитования и финансового лизинга.
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              ...
              разработки и внедрения систем управления лизингом и кредитованием
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-12">
              ...
              воедино. Так как система реализована по модульному принципу,
              имеется возможность запуска отдельных модулей в зависимости от

          ...
          <main className="lg:w-3/4 order-1 lg:order-2">
            ...
            <div className="space-y-6 sm:space-y-8 mb-8">
              <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300">
                Система «Управление микрофинансовой организацией» (УМФО)
                предлагает комплексное решение для автоматизации ключевых
                бизнес-процессов финансовых организаций. Это инновационное
                решение разработано на базе системы 1С Предприятие 8
                Бухгалтерский учет для Казахстана ред. 3.0 и полностью
                интегрировано с бухгалтерским учетом.
              </p>

              <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300">
                УМФО реализована с использованием облачных технологий и
                предоставляется на основе аренды (размещение базы данных на
                сервере компании «ERPCloud» с подключением через Интернет или
                VPN), либо путем передачи лицензий для установки на сервер
                заказчика.
              </p>
            </div>
            ...
            <section className="mt-10 sm:mt-12">
              ...
              <ul className="space-y-3 sm:space-y-4">
                {[
                  ...
                  {
                    text: "Открытие кредитных линий и выдача займов",
                    emoji: "💰",
                  },
                  {
                    text: "Формирование договоров и расчет графиков погашения",
                    emoji: "📊",
                  },
                  {
                    text: "Учет задолженности и начисление вознаграждений",
                    emoji: "💼",
                  },
              ...
              <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
                <div className="bg-gray-50 dark:bg-gray-800 p-4 sm:p-6 rounded-lg">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                      Формирование электронных и печатных документов по шаблонам
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 dark:bg-gray-800 p-4 sm:p-6 rounded-lg">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                      Начисление вознаграждения, пени, учет просроченных
                      обязательств
                    </li>
            ...
            <section className="mt-10 sm:mt-12">
              ...
              <div className="bg-gray-100 dark:bg-gray-800 p-4 sm:p-6 rounded-lg">
                <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    Периодические расчеты (дисконтирование, расчет провизий)
                  </li>
                </ul>
                <div className="mt-4 sm:mt-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                      Накопление стоимости предметов лизинга, включая доп.
                      расходы
                    </li>
